...
// console.log((2.3534687215).toFixed(4));
...
// //String
// const string = ("a 'sdfg' hj", 'sd"ahj"sd', ``);
// console.log("'sdfg" +
//     "\\n hj'");
...
// const typeSymbol = Symbol('Hello');

// //об'єктні типи що змінюються
// const arr = [1, 2, 3, 4, 5, '', {}, [], function () { }, null, undefined]
// arr[0] = 6;
// // [[0, 0, 0], [0, 0, 0], [0, 0, 0]]
// console.log(arr);
...
// console.log(+'34');
// console.log(+'2', parseInt('1.1'), parseFloat('1.5'), ~~(2.5));

// //!!!!!!!!!!!
// console.log(false, !!'', !!0, !!-0, !!undefined, !!null, !!NaN);
// console.log(!!1234, !!"hello", !!Infinity);

// console.log(2 == '2', 2 === '2', 2 < 5, 2 > 5, 2 <= 5);
// //!= !==
// console.log([] === []);
// const a = [];
// const b = a;
...
// // const ddd = +prompt('age?') || 10;
// // const ddd = +prompt('age?') ?? 10;
// // console.log(ddd)

// console.log(12 % 5) //залишок від ділення
